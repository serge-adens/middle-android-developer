...
class ExampleUnitTest {
    ...
    fun import_users() {
        val holder = UserHolder
        val users = holder.importUsers(
            listOf(
                "  John Doe ;John_Doe@unknown.com;[B@77846d2c:78b2b89aa1513ffbe83c7672d8afe6e4;;",
                "John Doe ;;[B@77846d2c:78b2b89aa1513ffbe83c7672d8afe6e4;+7 (917) 971-11-11"
            )
        )
        Assert.assertTrue(users.count() == 2)

        val result1 =  holder.loginUser("John_Doe@unknown.com", "testPass")
        val expectedInfo1 = """
            firstName: John
            lastName: Doe
            login: john_doe@unknown.com
            ...
            meta: {src=csv}
        """.trimIndent()
        Assert.assertEquals(expectedInfo1, result1)

        val result2 =  holder.loginUser("+7 (917) 971-11-11", "testPass")
        val expectedInfo2 = """
            firstName: John
            lastName: Doe
            login: +79179711111
            ...
            meta: {src=csv}
        """.trimIndent()
        Assert.assertEquals(expectedInfo2, result2)
    }

    @Test
    fun drop_last_until() {
        val toTypedArray = listOf(1, 2, 3).dropLastUntil { it == 2 }.toTypedArray()
        Assert.assertArrayEquals(arrayOf(1), toTypedArray)
        val toTypedArray2 = "House Nymeros Martell of Sunspear".split(" ").dropLastUntil { it == "of" }.toTypedArray()
        Assert.assertArrayEquals(arrayOf("House", "Nymeros", "Martell"), toTypedArray2)
    }
}
